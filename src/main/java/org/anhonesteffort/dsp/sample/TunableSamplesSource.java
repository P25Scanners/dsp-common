...
public abstract class TunableSamplesSource extends ConcurrentSource<Samples, DynamicSink<Samples>> {
  ...
  public Double getMinTunableFreq() {
    return minTunableFreq;
  }

  public Double getMaxTunableFreq() {
    return maxTunableFreq;
  }
  ...
  @Override
  public void addSink(DynamicSink<Samples> sink) {
