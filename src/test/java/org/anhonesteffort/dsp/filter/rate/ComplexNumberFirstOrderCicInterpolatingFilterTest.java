...
import org.anhonesteffort.dsp.util.FrequencySweep;
import org.junit.Test;

import java.util.stream.LongStream;

import static org.anhonesteffort.dsp.filter.FilterSinks.CountAndSumSink;
import static org.anhonesteffort.dsp.filter.FilterSinks.SignalSink;
...
public class ComplexNumberFirstOrderCicInterpolatingFilterTest {
  ...
  public void testSweep() {
    ...
    final Filter<ComplexNumber> CIC = FilterFactory.getCicInterpolate(SOURCE_RATE, DESIRED_RATE);
